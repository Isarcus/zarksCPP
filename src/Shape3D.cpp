...
Shape3D::Shape3D(const std::vector<Vec3>& vertices, const std::vector<int>& indices)
    : vertices(vertices)
    , indices(indices)
{}
...
Shape3D Shape3D::Polygon(const std::vector<Vec3>& points2D, bool ccw)
{
    Shape3D polygon;
...
Shape3D Shape3D::TriangularPyramid(const std::array<Vec3, 4>& vertices, bool acceptOrder)
{
    Shape3D pyramid;
