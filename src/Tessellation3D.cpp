...
Tessellation3D::Tessellation3D(const double* vertices, int numTri)
{
	int idx = 0;
...
Tessellation3D& Tessellation3D::Add(const Triangle3D& tri)
{
	data.push_back(tri);
...
void Tessellation3D::WriteVertex(std::ofstream& f, Vec3 v)
{
	char buf[4];
